...
resource "azurerm_policy_definition" "deploy_asc_defender_arm" {
...
output "policydefinition_deploy_asc_defender_arm" {
  value = azurerm_policy_definition.deploy_asc_defender_arm
}
