...
resource "azurerm_policy_definition" "deploy_asc_defender_acr" {
...
output "policydefinition_deploy_asc_defender_acr" {
  value = azurerm_policy_definition.deploy_asc_defender_acr
}
