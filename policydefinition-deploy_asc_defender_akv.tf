...
resource "azurerm_policy_definition" "deploy_asc_defender_akv" {
...
output "policydefinition_deploy_asc_defender_akv" {
  value = azurerm_policy_definition.deploy_asc_defender_akv
}
