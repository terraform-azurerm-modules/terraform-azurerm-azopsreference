...
resource "azurerm_policy_definition" "deploy_asc_defender_vms" {
...
output "policydefinition_deploy_asc_defender_vms" {
  value = azurerm_policy_definition.deploy_asc_defender_vms
}
