...
resource "azurerm_policy_definition" "deploy_asc_defender_dns" {
...
output "policydefinition_deploy_asc_defender_dns" {
  value = azurerm_policy_definition.deploy_asc_defender_dns
}
