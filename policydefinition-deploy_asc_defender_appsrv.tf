...
resource "azurerm_policy_definition" "deploy_asc_defender_appsrv" {
...
output "policydefinition_deploy_asc_defender_appsrv" {
  value = azurerm_policy_definition.deploy_asc_defender_appsrv
}
