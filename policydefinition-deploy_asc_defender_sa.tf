...
resource "azurerm_policy_definition" "deploy_asc_defender_sa" {
...
output "policydefinition_deploy_asc_defender_sa" {
  value = azurerm_policy_definition.deploy_asc_defender_sa
}
