...
find $REFDIR -iname *policyDefinitions* -print0 | xargs -0 -I % -n 1 -P 8 bash -c "process_policydef \"%\" $OUTDIR"

# Find all policySetDefinitions and convert in parallel
find $REFDIR -iname *policySetDefinitions* -print0 | xargs -0 -I % -n 1 -P 8 bash -c "process_policysetdef \"%\" $OUTDIR"
